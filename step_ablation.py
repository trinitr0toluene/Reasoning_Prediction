...
def main():
    ...
    parser.add_argument("--raw-masked", type=str, default="/root/autodl-tmp/out20/raw_masked.jsonl")
    parser.add_argument("--macro-steps", type=str, default="/root/autodl-tmp/out20/macro_steps.jsonl")
    parser.add_argument("--sentences", type=str, default="/root/autodl-tmp/out20/sentences.jsonl")
    parser.add_argument("--out", type=str, default="/root/autodl-tmp/out20/ablation_results.jsonl")
